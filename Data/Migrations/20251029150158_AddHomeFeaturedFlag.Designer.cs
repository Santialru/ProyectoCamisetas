...
namespace ProyectoCamisetas.Data.Migrations
{
    ...
    [Migration("20251029150158_AddHomeFeaturedFlag")]
    partial class AddHomeFeaturedFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoCamisetas.Models.Camiseta", b =>
                {
                    ...
                    b.Property<bool>("DestacadaInicio")
            ...
            modelBuilder.Entity("ProyectoCamisetas.Models.CamisetaTalleStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<short>("Talla")
                        .HasColumnType("smallint")
                        .HasColumnName("talla");

                    b.HasKey("Id")
                        .HasName("pk_camiseta_talles");

                    b.HasIndex("CamisetaId")
                        .HasDatabaseName("ix_camiseta_talles_camiseta_id");

                    b.HasIndex("CamisetaId", "Talla")
                        .IsUnique()
                        .HasDatabaseName("ix_camiseta_talles_camiseta_id_talla");

                    b.ToTable("camiseta_talles", (string)null);
                });
            ...
            modelBuilder.Entity("ProyectoCamisetas.Models.CamisetaTalleStock", b =>
                {
                    b.HasOne("ProyectoCamisetas.Models.Camiseta", "Camiseta")
                        .WithMany("TallesStock")
                        .HasForeignKey("CamisetaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_camiseta_talles_camisetas_camiseta_id");
